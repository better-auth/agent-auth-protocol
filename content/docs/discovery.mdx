...
Clients should prefer directory lookups over fetching arbitrary URLs provided by agents, as this provides a trust boundary for discovery. See the [Directory](/registry) page for available directories and the search API.
