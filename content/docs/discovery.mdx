---
title: Discovery
description: Discovery is how agents find and connect to services — through well-known endpoints, registries, and direct URL fetching.
section: "Concepts"
---
...
Clients should prefer registry lookups over fetching arbitrary URLs provided by agents, as this provides a trust boundary for discovery. See the [Registry](/registry) page for available registries and the search API.
