...
|||
|---|---|
| **Document** | draft-agent-auth-protocol-01 |
...
This document defines the Agent Auth Protocol, an HTTP-based protocol for AI agent identity, registration, capability-scoped authorization, and service discovery. It establishes how hosts and agents prove identity via asymmetric key pairs (EdDSA over Ed25519), receive scoped capability grants through user-approved or autonomous flows, and operate with clear attribution across their full lifecycle — from registration through revocation.

The protocol is designed to be adoptable by products and platforms today, with built-in support for existing infrastructure including HTTP APIs, OpenAPI operations, and MCP tools. It reuses established mechanisms (RFC 8628 Device Authorization, RFC 7519 JWT, RFC 7517 JWK) rather than inventing new primitives.

## Status of This Document

This is a working draft and may be updated, replaced, or obsoleted at any time. It is inappropriate to cite this document as anything other than work in progress. Distribution of this document is unlimited.

The protocol has a reference [implementation](/code) covering all parts of this specification, maintained by the team behind [Better Auth](https://better-auth.com).
...
- **[RFC 2119]** Bradner, S., "Key words for use in RFCs to Indicate Requirement Levels", BCP 14, RFC 2119, DOI 10.17487/RFC2119, March 1997. https://datatracker.ietf.org/doc/html/rfc2119
- **[RFC 7517]** Jones, M., "JSON Web Key (JWK)", RFC 7517, DOI 10.17487/RFC7517, May 2015. https://datatracker.ietf.org/doc/html/rfc7517
- **[RFC 7519]** Jones, M., Bradley, J., and N. Sakimura, "JSON Web Token (JWT)", RFC 7519, DOI 10.17487/RFC7519, May 2015. https://datatracker.ietf.org/doc/html/rfc7519
- **[RFC 7638]** Jones, M. and N. Sakimura, "JSON Web Key (JWK) Thumbprint", RFC 7638, DOI 10.17487/RFC7638, September 2015. https://datatracker.ietf.org/doc/html/rfc7638
- **[RFC 8032]** Josefsson, S. and I. Liusvaara, "Edwards-Curve Digital Signature Algorithm (EdDSA)", RFC 8032, DOI 10.17487/RFC8032, January 2017. https://datatracker.ietf.org/doc/html/rfc8032
- **[RFC 8037]** Liusvaara, I., "CFRG Elliptic Curve Diffie-Hellman (ECDH) and Signatures in JSON Object Signing and Encryption (JOSE)", RFC 8037, DOI 10.17487/RFC8037, January 2017. https://datatracker.ietf.org/doc/html/rfc8037
- **[RFC 8174]** Leiba, B., "Ambiguity of Uppercase vs Lowercase in RFC 2119 Key Words", BCP 14, RFC 8174, DOI 10.17487/RFC8174, May 2017. https://datatracker.ietf.org/doc/html/rfc8174
- **[RFC 8628]** Denniss, W., Bradley, J., Jones, M., and H. Tschofenig, "OAuth 2.0 Device Authorization Grant", RFC 8628, DOI 10.17487/RFC8628, August 2019. https://datatracker.ietf.org/doc/html/rfc8628
- **[RFC 9111]** Fielding, R., Ed., Nottingham, M., Ed., and J. Reschke, Ed., "HTTP Caching", STD 98, RFC 9111, DOI 10.17487/RFC9111, June 2022. https://datatracker.ietf.org/doc/html/rfc9111

### 13.2 Informative References

- **[RFC 5869]** Krawczyk, H. and P. Eronen, "HMAC-based Extract-and-Expand Key Derivation Function (HKDF)", RFC 5869, DOI 10.17487/RFC5869, May 2010. https://datatracker.ietf.org/doc/html/rfc5869
- **[RFC 7235]** Fielding, R., Ed. and J. Reschke, Ed., "Hypertext Transfer Protocol (HTTP/1.1): Authentication", RFC 7235, DOI 10.17487/RFC7235, June 2014. https://datatracker.ietf.org/doc/html/rfc7235
- **[RFC 7662]** Richer, J., Ed., "OAuth 2.0 Token Introspection", RFC 7662, DOI 10.17487/RFC7662, October 2015. https://datatracker.ietf.org/doc/html/rfc7662
- **[RFC 8693]** Jones, M., Nadalin, A., Campbell, B., Ed., Bradley, J., and C. Mortimore, "OAuth 2.0 Token Exchange", RFC 8693, DOI 10.17487/RFC8693, January 2020. https://datatracker.ietf.org/doc/html/rfc8693
- **[RFC 8705]** Campbell, B., Bradley, J., Sakimura, N., and T. Lodderstedt, "OAuth 2.0 Mutual-TLS Client Authentication and Certificate-Bound Access Tokens", RFC 8705, DOI 10.17487/RFC8705, February 2020. https://datatracker.ietf.org/doc/html/rfc8705
- **[RFC 9449]** Fett, D., Campbell, B., Bradley, J., Lodderstedt, T., Jones, M., and D. Waite, "OAuth 2.0 Demonstrating Proof of Possession (DPoP)", RFC 9449, DOI 10.17487/RFC9449, September 2023. https://datatracker.ietf.org/doc/html/rfc9449
- **[RFC 9728]** Jones, M., Hunt, P., and A. Parecki, "OAuth 2.0 Protected Resource Metadata", RFC 9728, DOI 10.17487/RFC9728, December 2024. https://datatracker.ietf.org/doc/html/rfc9728
- **[OpenID CIBA]** Fernandez, G., Walter, F., Nandakumar, A., Campbell, B., "OpenID Connect Client-Initiated Backchannel Authentication Flow - Core 1.0", September 2021. https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html
- **[WebAuthn]** Hodges, J., Jones, J.C., Jones, M.B., Kumar, A., Lundberg, E., Ed., "Web Authentication: An API for accessing Public Key Credentials Level 2", W3C Recommendation, April 2021. https://www.w3.org/TR/webauthn-2/

## 14. Authors' Addresses

Paola Estefanía\
Better Auth\
Email: paola@better-auth.com

Bereket Engida\
Better Auth\
Email: bereket@better-auth.com
