...
Capabilities are listed via `/capability/list` (§6.2) and executed through `POST /capability/execute` (§6.11). The discovery document covers identity and authorization configuration only.
